...
(function () {
  ...
  AudioEvent.prototype.reset = function (fromPart, fromTrack, fromSong) {
    fromPart = fromPart === undefined
    fromTrack = fromTrack === undefined
    fromSong = fromSong === undefined
...
*/
  ...
  millisToTicks = function (song, targetMillis, beos) {
    beyondEndOfSong = beos === undefined
