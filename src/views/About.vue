  ...
  <div class="about">
    ...
    <div class="about-content">
      ...
      <div class="content-body">
        <ol id="instruction-list">
          ...
          <li>Press <v-btn color="blue darken-2" dark small fab><v-icon>play_arrow</v-icon></v-btn> play to hear the output!</li>
      ...
      <h2>Cool Examples</h2>
      <div class="content-body">
        <v-btn-toggle class="control-group-toggle" v-model="window" mandatory>
          <v-btn text v-for="(ptype, index) in predictionTypes" v-bind:key="ptype.name" :value="index" color="red">
            {{ptype.displayName}}
          </v-btn>
        </v-btn-toggle>
        ...
        <v-window v-model="window" class="elevation-1">
          <v-window-item :key="0">
            <v-card flat>
              <v-card-text>
                <div class="title">Start with few notes and continue the idea.</div>
                <ul>
          ...
          <v-window-item :key="1">
            <v-card flat>
              <v-card-text>
                ...
                <div class="title">Generate a new melody on top of an existing chord progression.</div>
                <ul>
          ...
          <v-window-item :key="2">
            <v-card flat>
              <v-card-text>
              <!-- <h4>Harmonization</h4> -->
              <div class="title">Add chords to your melody</div>
              <ul>
          ...
          <v-window-item :key="3">
            <v-card flat>
              <v-card-text>
                <!-- <h4>Note Remixing</h4> -->
                <div class="title">Generate a completely new song in the exact same tempo as the original</div>
                <ul>
      ...
      <div class="content-body">
        ...
        <ul>
          <li><div class="note seed"></div> = Seed notes. The model uses these to predict the next sequence.</li>
          <li><div class="note generated"></div> = Generated notes - they get replaced on every new prediction.</li>
          <li><div class="note original"></div> = Original notes of the song.</li>
        </ul>
      </div>
    ...
    <div class="content-body">
      ...
      <div id="about-seed">
          ...
          <br><div class="note seed"></div> notes are used to predict the next sequence.
          <br><div class="note generated"></div> notes are overwritten with new predicted notes.
      </div>
      <h4>Grid editor
      </h4>
    ...
    <h2>What's with the name? <img id="icon-autobot" src="@/assets/autobot_optimus.png"></h2>
    <div class="content-body">
    ...
    <ul class="variation-list">
      <li><a href="https://github.com/bearpelican/musicautobot_vueapp" target="_blank">Vue App</a></li>
      <li><a href="https://github.com/bearpelican/musicautobot" target="_blank">Python Model</a></li>
    </ul>
